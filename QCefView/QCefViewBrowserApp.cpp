...
QCefViewBrowserApp::OnBeforeCommandLineProcessing(const CefString& process_type, CefRefPtr<CefCommandLine> command_line)
{
  ...
  command_line->AppendSwitch("--allow-http-background-page");
  command_line->AppendSwitch("--allow-running-insecure-content");
  command_line->AppendSwitch("--ignore-urlfetcher-cert-requests");
  command_line->AppendSwitch("--ignore-certificate-errors");
  command_line->AppendSwitch("--user-gesture-required");
  command_line->AppendSwitch("--disable-spelling-feedback-field-trial");
  command_line->AppendSwitch("--no-proxy-server");
  command_line->AppendSwitch("--high-dpi-support");
  command_line->AppendSwitch("--force-device-scale-factor");
}
